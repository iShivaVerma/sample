				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a href="#about" class="active">Withdrawal</a></li>
							<li><a href="#services" class="active">Cheque Book Request</a></li>
							<li><a href="#blog" class="active">Transactions</a></li>
							<li><a href="changePhoneNumber.jsp" class="active">Change PhoneNumber</a></li>
							<li><a href="Pin.jsp" class="active">Reset Pin</a></li>
						</ul>	
